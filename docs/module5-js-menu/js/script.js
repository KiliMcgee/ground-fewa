...
function buildAndShowHomeHTML(categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      var chosenCategoryShortName = chooseRandomCategory(categories)?.short_name ?? "SP";
      console.log(`Dumping chosen category short name: ${chosenCategoryShortName} | `, categories);
